...
Ce paquet met en œuvre le moteur du routeur solaire qui détermine quand et combien d'énergie doit être détournée vers trois charges utilisant trois canaux, ou une seule charge avec trois canaux comme un chauffe-eau avec trois résistances de chauffage.
...
3. 3ème canal: Régulateur TRIAC ou SSR (Contrôl variable)
